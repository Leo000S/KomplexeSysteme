...
\begin{align*}
     P_n(t)&=\left(\frac{\omega_\uparrow}{\omega_\downarrow}\right) P_{n-1}(t) \Rightarrow P_n(t)=\left(\frac{\omega_\uparrow}{\omega_\downarrow}\right)^n P_{0}(t)\\
     \text{for n+1:}\ 0 &=  w_\uparrow P_{n}(t) + w_\downarrow P_{n+2}(t) - (w_\uparrow + w_\downarrow) P_{n+1}(t)= w_\downarrow P_{n+1}(t) + w_\downarrow P_{n+2}(t) - (w_\uparrow + w_\downarrow) P_{n+1}(t)\\
...
\]
by recursion. Where $P_n$ is the n-th component of the right eigenvector to the eigenvalue zero.
\subsection*{(c)}
...
\begin{align*}
    ...
    P_0 &= 1-\frac{w_\uparrow}{w_\downarrow}\\
    \Rightarrow
\end{align*}
...
\begin{align*}
    p_n \propto e^{\frac{E_n}{k_B T}} &= \text{exp}\left(\frac{\hbar \omega }{2k_B T}\right)\cdot \text{exp}\left(\frac{\hbar \omega n}{k_B T}\right)\\
